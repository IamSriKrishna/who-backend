...
from dependencies.dependencies import db_dependency, user_dependency
from controller.auth.auth import create_user as create_user_func, login_for_access_token as login_func, get_user as get_user_func
